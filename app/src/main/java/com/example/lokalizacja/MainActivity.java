            ...
            fusedLocationClient.getLastLocation().addOnSuccessListener(new OnSuccessListener<Location>() {
                ...
                public void onSuccess(Location location) {
                    if(location != null){
                        ...
                        double czas = location.getTime();
                        String opis = "Długość geograficzna: "+dlugoscGeograficzna+"\nSzerokość geograficzna: "+szerokoscGeograficzna+"\nCzas: "+czas;
                        textView.setText(opis);
                        Log.d("Lokalizacja",szerokoscGeograficzna+" "+dlugoscGeograficzna);
                    }
                }
            });
        }
